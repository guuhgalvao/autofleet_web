	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link disabled" href="/system/rent.php">Alugar Veículos</a></li>
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item disabled" href="/system/manager/fines.php">Multas</a>
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
						<a class="dropdown-item disabled" href="/system/reports/reportreservations.php"> Reservas</a>
						<a class="dropdown-item disabled" href="/system/reports/reportfines.php">Multas</a>
					</div>
				</li>
			</ul>
